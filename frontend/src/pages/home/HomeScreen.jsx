    ...
    <div className='relative h-screen text-white'>
      ...
      <div className='absolute top-0 left-0 w-full h-full flex flex-col justify-center px-8 md:px-16 lg:px-32'>
        ...
        <div className='max-w-2xl'>
          ...
          <p className='mt-4 text-lg'>Chris Hemsworth stars in this nonstop action-thriller with Rudraksh Jsiswal, Reandeep Hooda and Golshifteh Farahani</p>
        </div>
        ...
        <div className='flex mt-8'>
          ...
          <Link to="/watch/123" className='bg-gray-500 text-white py-2 px-4 rounded flex items-center'>
          <Info className='size-6 mr-2'></Info>
          More Info
          </Link>
        </div>
